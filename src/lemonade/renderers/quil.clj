(ns lemonade.renderers.quil
  (:require [clojure.string :as string]
            ...
            [lemonade.renderers.colours :as colours]
            [lemonade.renderers.util :as util]
            [lemonade.util :refer [implement-sequentials]]
...
(extend-protocol QuilRenderable
  ...
  lemonade.core.AffineTransformation
